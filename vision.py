...
class VisionPipeline:
    def __init__(self):
        ...
        self.bg_subtractor = cv.createBackgroundSubtractorMOG2(history=500, varThreshold=20, detectShadows=False)
    ...
    def process_frame(self, gray_frame):
        ...
        clean_mask = cv.morphologyEx(raw_mask, cv.MORPH_OPEN, self.kernel)
